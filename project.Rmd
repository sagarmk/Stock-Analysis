...
Building a GLM model to do sentiment analysis on tweets:
...
Building and training model using classified tweets:
```{r}
...
Performing sentiment analysis on top 25 news topics of each day:
```{r}
...
NEURAL NETWORK with increased number of neurons in first hidden layers:
